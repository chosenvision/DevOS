  ...
  return (
    <aside className="hidden w-60 shrink-0 flex-col border-r border-sidebar-border bg-sidebar lg:flex">
      ...
      <div className="px-3 pb-3">
        <QuickAddTrigger className="flex w-full items-center gap-2 rounded-md border border-sidebar-border bg-sidebar px-2.5 py-1.5 text-sm text-sidebar-foreground/70 shadow-xs transition-colors hover:bg-sidebar-accent hover:text-sidebar-foreground">
