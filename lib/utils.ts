...
const MOTIVATIONAL_MESSAGES = [
  "Here's what you've got going on today.",
  ...
  "Consistency beats intensity. Let's get to it.",
  "One focused session can move a project forward.",
  "Progress, not perfection. Let's see what's next.",
];
