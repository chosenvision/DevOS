      ...
      <main className="flex-1">
        ...
        <section className="border-t border-border">
          <div className="mx-auto max-w-6xl px-6 py-16 sm:py-20">
            <Reveal mode="inView" className="mx-auto max-w-xl text-center">
            ...
            <Stagger mode="inView" className="mt-10 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
              {FEATURES.map((feature) => (
                <StaggerItem key={feature.title}>
                  <TiltCard className="group flex flex-col gap-3 rounded-xl border border-border/80 bg-card p-6 shadow-soft transition-shadow duration-200 hover:border-primary/30 hover:shadow-soft-lg">
                    <span
                      className={cn(
        ...
        <section className="border-t border-border bg-secondary/30">
          <Reveal
            mode="inView"
            className="mx-auto flex max-w-4xl flex-col items-center gap-5 px-6 py-16 text-center sm:py-20"
          >
